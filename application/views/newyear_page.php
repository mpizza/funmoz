...
<hgroup id="main-feature">
  ...
  <div id="feature-des">
    <p>準備好迎接嶄新的一年嗎？做為網路自由開放的捍衛者，Firefox 相信網際網路是全球公用資源，理應保持開放並依個人意願決定網路的使用方式。</p>
    <p>Firefox 的新年願望是持續維護網路環境的開放創新，透過全體社群的力量打造更美好的網路環境。現在，我們邀請你/妳透過跨年許願卡，與我們一同傳遞網路開放自由創新的理念。</p>
...
<div id="main-content">
  <section class="main_section">
    <div class="canvas_wrapper">
      ...
      <canvas id="pad" width="800" height="600">
        你的瀏覽器並不支援Canvas，更棒的網路體驗請下載 最新的 <a href="http://mozilla.com.tw/firefox/" title="全新的 Firefox">Firefox</a>
      </canvas>
    </div>
    ...
    <div id="tool">
      <input type="button" value="left" id="left_bt" />
      <input type="button" value="right" id="right_bt" />
  ...
  <section class="social_content">
    ...
    <ul class="sharelist">
        <li>
          <a class="fb" target="_blank" href="http://www.facebook.com/sharer/sharer.php?s=100&p[url]=http://fun.mozilla.com.tw/newyear/&p[title]=<?php echo $title; ?>&p[images][0]=http://fun.mozilla.com.tw/assets/pic/xmas2012/share_FB.jpg&p[summary]=<?php echo $meta_desc; ?>">
            Facebook
          </a>
        </li>
        <li>
          <a class="pk" href="javascript: void(window.open('http://www.plurk.com/?qualifier=shares&amp;status=' .concat(encodeURIComponent('http://fun.mozilla.com.tw/newyear/')) .concat(' ') .concat('(') .concat(encodeURIComponent('Firefox 聖誕報佳音')) .concat(')')));">
            [推到Plurk]
          </a>
        </li>
        <li id="gplist" class="default-gp">
          <div onClick="_gaq.push(['_trackEvent', '2012Xmas', 'gp', 'gpshare']);" class="g-plusone" data-size="medium" data-annotation="inline"  data-href="http://fun.mozilla.com.tw/newyear/" data-width="120"></div>
        </li>
      </ul>
  </section>
</div>